...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/articles.js":[function(require,module,exports) {
"use strict";
...
exports.cleanSetOrder = cleanSetOrder;

function setOrder() {
  var articles = document.querySelector(".posts-list");
  if (articles == null) return;
  var rem = parseInt(getComputedStyle(document.body).fontSize);
  console.log("called");

  if (window.innerWidth < 800) {
    console.log(window.innerWidth);
    articles.removeAttribute("style");
    articles.querySelectorAll(".card").forEach(function (element) {
  ...
  secondColumn.forEach(function (element, index) {
...
exports.cleanSidebar = cleanSidebar;
...
function sidebar() {
  ...
  var observer = new IntersectionObserver(toggleSidebar, {});
...
function hamburger() {
  ...
  var menuNav = document.querySelector(".nav__links");
...
window.onload = function () {
  ...
  swup.on('willReplaceContent', function () {
    (0, _articles.cleanSetOrder)();
    (0, _sidebar.cleanSidebar)();
    document.body.scrollTop = 0; // For Safari

    document.documentElement.scrollTop = 0; // For Chrome, Firefox, IE and Opera
  });
};
},{"./articles":"js/articles.js","./sidebar":"js/sidebar.js","./hamburger":"js/hamburger.js","swup":"../node_modules/swup/lib/index.js"}]},{},["js/main.js"], null)
